<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmPurchaseRegisterReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmPurchaseRegisterReport" %>
   ...
   <div style="width: 100%; height: 20px; border-radius: 4px; margin: 5px 0px 0px 10px; background-color: #1564ad; color: white; padding: 0px 0px 0px 0px; font-weight: bold">
    ...
    <asp:Panel ID="pnlHeader" runat="server"  GroupingText="Filter" Style="width: 99%; margin: 0px 0px 0px 2px;" >
            ...
            <tr>
                ...
                <td >
                    <asp:Button ID="BtnShowReport0" runat="server" CssClass="ReportSearch" Height="31px" Visible="false" OnClick="BtnShowReport_Click" Text="Show Report" Width="96px" />
                </td>
               <td>
     ...
     <div style="margin:10px">
          <asp:Panel ID="PanelReport" runat="server" GroupingText="Purchase Register Report" Width="100%"  BackColor="White" >
