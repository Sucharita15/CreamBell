<%@ Page Title="PSR WISE SALES REPORT" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmPSRWiseSalesReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmPSRWiseSalesReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <asp:UpdatePanel ID="uppanel" runat="server" UpdateMode="Conditional">
     ...
     <asp:Panel ID="pnlHeader" runat="server" GroupingText="Filter" style="width: 99%;margin: 0px 0px 0px 10px;" >
        <table style="width:100%">
            ...
            <tr>
                ...
                <td>PSR Code</td>
                <td>
                    <asp:DropDownList ID="ddlPSR" runat="server" AutoPostBack="true" CssClass="textboxStyleNew" Font-Size="Smaller" Height="22px" Width="120px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>Product:</td>
               <td>
                     <asp:DropDownList ID="drpProduct" runat="server" AutoPostBack="True" CssClass="textboxStyleNew" Font-Size="Smaller" Height="22px"  Width="120px" >
                    </asp:DropDownList>
                </td>
                <td>
                    Customer Group</td>
                <td>
                     <asp:DropDownList ID="drpCustGroup" runat="server" AutoPostBack="True" CssClass="textboxStyleNew" Font-Size="Smaller" Height="22px"  Width="120px">
                    </asp:DropDownList>
                </td>
                <td>Business Unit</td>
                <td>
     ...
     <div style="margin:10px">
                <asp:Panel ID="PanelReport" runat="server" GroupingText="PSR Wise Sales Report" Width="100%"  BackColor="White" >
