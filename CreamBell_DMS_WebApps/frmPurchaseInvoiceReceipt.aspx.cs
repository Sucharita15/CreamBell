...
{
    public partial class frmPurchaseInvoiceReceipt : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    //if (ReturnArray != null)
                    {
                        ...
                        decimal Box = Convert.ToDecimal(BoxQty);
                ...
                if (dtForShownUnuploadData.Rows.Count > 0)
                {
                    ...
                    gridviewRecordNotExist.DataBind();
                    //  ModalPopupExtender1.Show();
                    ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "Refresh()", true);
                    _dtLine = null;
