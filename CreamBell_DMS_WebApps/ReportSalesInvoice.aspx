<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReportSalesInvoice.aspx.cs" Inherits="CreamBell_DMS_WebApps.ReportSalesInvoice" %>
            ...
            <table style="width: 100%; vertical-align:top;">
                ...
                <tr>
                    ...
                    <td class="auto-style15">
                        <asp:TextBox ID="txtSearch" Enabled="false" runat="server" placeholder="Search here...." Width="120px"></asp:TextBox>
                    </td>
               
                    <td class="auto-style7">InvoiceType:</td>
                    <td class="auto-style14">
                        <asp:RadioButton ID="rdoBoth" runat="server" AutoPostBack="true" Text="All" visible="false"
                            OnCheckedChanged="rdoBoth_CheckedChanged" GroupName="radio" />

                        <asp:RadioButton ID="rdoSI" runat="server" AutoPostBack="true" Text="SI" Checked="true"
                            OnCheckedChanged="rdoBoth_CheckedChanged" GroupName="radio" />

                        <asp:RadioButton ID="rdoSR" runat="server" AutoPostBack="true" Text="SR" visible="false"
                            OnCheckedChanged="rdoBoth_CheckedChanged" GroupName="radio" />

                        <asp:RadioButton ID="rdoFOC" runat="server" AutoPostBack="true" Text="FOC" visible="false"
                            OnCheckedChanged="rdoBoth_CheckedChanged" GroupName="radio" />
                    ...
                    <td>Customer:</td>
                    <td>
                        <asp:DropDownList ID="drpCustomer" runat="server" Width="150"></asp:DropDownList></td>
                    <td style="text-align: left">
                        <asp:Button ID="btnSearch" runat="server" CssClass="button" Height="30px" Text="Search" Width="70px" OnClick="btnSearch_Click" />
                    </td>
                    <td>
                        <asp:Button ID="Button2" runat="server" Text="MultiplePrint" CssClass="button" Height="31px" OnClick="Button2_Click" Visible="true" />
                    </td>
                    </tr>
                <tr>
                    <td>
