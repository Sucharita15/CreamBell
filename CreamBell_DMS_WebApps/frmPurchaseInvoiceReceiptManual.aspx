<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmPurchaseInvoiceReceiptManual.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmPurchaseInvoiceReceiptManual" %>
                    ...
                    <td style="width: 100%">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td class="auto-style5">
                                    <asp:RadioButton ID="rdoExcelEntry" runat="server" AutoPostBack="true" Text="Excel Upload" Checked="true" Visible="false"
                                        OnCheckedChanged="rdoManualEntry_CheckedChanged" GroupName="radio" />
                                </td>
                                <td class="auto-style5">
                                    <asp:RadioButton ID="rdoSAPFetchData" runat="server" AutoPostBack="true" Text="SAP" Visible="false"
                                        OnCheckedChanged="rdoManualEntry_CheckedChanged" GroupName="radio" />
                                </td>
