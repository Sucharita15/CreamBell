<%@ Page Title="Vending Expense Calculation" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmVendingExpenseCalculation.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmVendingExpenseCalculation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div style="width: 99%; height: 18px; border-radius: 4px; margin: 10px 0px 0px 5px; background-color: #0085ca; padding: 2px 0px 0px 0px;">
        <span style="font-family: Segoe UI; font-size: 11px; font-weight: bold; margin: 6px 0px 0px 10px; color: #FFFFFF;">Vending Expense Calculation</span>
    </div>
    <div style="width: 99%">
            ...
            <ContentTemplate>
                <table style="width: 100%; text-align: left">
                    <tr>
                      ...
                      <%--  <td style="width: 8%;">Select VRS :</td>
                        <td style="width: 15%;">
                            <asp:DropDownList ID="ddlVRS" runat="server" AutoPostBack="True" CssClass="textboxStyleNew" Font-Size="Smaller" Height="21px" OnSelectedIndexChanged="ddlVRS_SelectedIndexChanged" Width="98%">
                            </asp:DropDownList>
                        </td>--%>
