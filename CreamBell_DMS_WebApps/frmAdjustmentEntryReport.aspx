<%@ Page Title="" Language="C#" MasterPageFile="~/New.Master" AutoEventWireup="true" CodeBehind="frmAdjustmentEntryReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmAdjustmentEntryReport" %>
     ...
     <asp:UpdatePanel ID="pnlupd" runat="server">
                <ContentTemplate>   
                    ...
                    <asp:Panel ID="pnlHeader" runat="server"  GroupingText="Filter" CssClass="txtLegend" Style="width: 100%; margin: 0px 0px 0px 0px;">
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="Panel1" runat="server"  GroupingText="Adjustment Entry Report" Style="width: 100%; margin: 0px 0px 0px 0px;">                                        
                       ...
                       <div>
                          ...
                          <asp:RadioButtonList ID="rdoInvoiceType" runat="server" AutoPostBack="true" RepeatColumns="3" RepeatLayout="Flow" RepeatDirection="Horizontal" >
                           ...
                           <asp:ListBox ID="lstSiteId" runat="server" SelectionMode="Multiple" ClientIDMode="Static" AutoPostBack="true" Width="200px"></asp:ListBox>                            
           ...
           <div style="margin:10px">
                 <asp:Panel ID="PanelReport" runat="server" GroupingText="Adjustment Entry Report" Width="100%"  BackColor="White" >
