<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmStockSnapshot.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmStockSnapshot" %>
...
&nbsp;</td>
      ...
      <div style="width: 98%;height: 18px;border-radius: 4px;margin: 10px 0px 0px 5px;background-color: #1564ad;padding: 2px 0px 0px 0px;" >
          Stock Snapshot as on :Current Date<br />

     </div>
      <div>
          <div style="overflow:auto;height:400px;margin: 10px 0px 0px 10px;" > 
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True" Width="998px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ShowHeaderWhenEmpty="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
             <Columns>
                 <asp:BoundField HeaderText="Product Code" />
                 <asp:BoundField HeaderText="Material Group" />
                 
                 <asp:BoundField HeaderText="Product Name" />
                 <asp:BoundField HeaderText="Opening Stock(A)" />
                 <asp:BoundField HeaderText="Recieved" />
                 <asp:BoundField HeaderText="Recieved OK (B)" />
                 <asp:BoundField HeaderText="Saleable(C=A+B)" />
                 <asp:BoundField HeaderText="Sales ( E )" />
                 <asp:BoundField HeaderText="Available For Sale (F=C-E)" />
                 <asp:BoundField HeaderText="Total Damage" />
