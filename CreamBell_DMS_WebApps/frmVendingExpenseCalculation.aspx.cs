...
{
    public partial class frmVendingExpenseCalculation : System.Web.UI.Page
    {
        ...
        protected void VRSClaimSetup_Save(int i, DataTable dtExpense, ref SqlCommand cmd, string NUMSEQ, string Doc_NO)
        {
            ...
            CALCULATION_ON = dtExpense.Rows[i]["CALCULATION ON"].ToString().ToUpper() == "FIX" ? "0" : "1";
            CLAIM_TYPE = Convert.ToString(drptargetType.SelectedIndex + 5);
            INCENTIVE_ON = dtExpense.Rows[i]["INCENTIVE ON"].ToString().ToUpper() == "VALUE" ? "0" : "1";
        ...
        private void ExportToExcelNew()
        {
            ...
            App_Code.Global.ExportDataTable(dtExpense, "VendingExpense.xls", "EXCEL", "DISTRIBUTOR EXPENSE");
        }
        ...
        //{
        //    ddlVRS.Items.Clear();
        //    string sqlstr11 = "EXEC Acx_GetVRS '"+ Session["SiteCode"].ToString() +"'";
        //    ddlVRS.Items.Add("All...");
        //    baseObj.BindToDropDown(ddlVRS, sqlstr11, "Name", "Code");
        //}
