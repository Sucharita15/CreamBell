<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmVendingCartVRSLinking.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmVendingCartVRSLinking" %>
...
&nbsp;</td>
     ...
     <div>
         ...
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True" Width="998px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ShowHeaderWhenEmpty="True">
             <Columns>
                 <asp:TemplateField HeaderText="VSRCode">
                     <EditItemTemplate>
                 ...
                 <asp:BoundField HeaderText="VSR Name" DataField="VSR Name" />
                 <asp:BoundField HeaderText="VRS Contact" DataField="Test1" />
                 <asp:BoundField HeaderText="VRS Address"  DataField="Test1"/>
