<%@ Page Title="" Language="C#" MasterPageFile="~/New.Master" AutoEventWireup="true" CodeBehind="frmVenderLedger.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmVenderLedger" %>
     ...
     <asp:UpdatePanel ID="pnlupd" runat="server">
                <ContentTemplate>   
                    ...
                    <asp:Panel ID="pnlHeader" runat="server"  GroupingText="Filter" CssClass="txtLegend" Style="width: 100%; margin: 0px 0px 0px 0px;">
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="Panel1" runat="server"  GroupingText="Vendor Ledger Report" Style="width: 100%; margin: 0px 0px 0px 0px;">                                        
                       ...
                       <div class="row">
                          ...
                          <label> To Date :</label>
                            ...
                            <%--<label style="margin-left:15px; margin-right:4px"> InvoiceType :</label>
                           
                 
                          <asp:RadioButtonList ID="rdoInvoiceType" runat="server" AutoPostBack="true" RepeatColumns="3" RepeatLayout="Flow" RepeatDirection="Horizontal" >
                               <asp:ListItem Text="Received" Value="Received" Selected="True"></asp:ListItem>
                           ...
                           <label >Supplier :</label>                            
                            ...
                            <asp:ListBox ID="chkListPlantNew" ClientIDMode="Static" runat="server" ></asp:ListBox>
           ...
           <div style="margin:10px">
                 <asp:Panel ID="PanelReport" runat="server" GroupingText="Vendor Ledger Report" Width="100%"  BackColor="White" >
