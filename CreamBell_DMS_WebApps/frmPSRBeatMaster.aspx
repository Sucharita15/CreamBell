<%@ Page Title="PSR-Beat Master" Language="C#" MasterPageFile="~/Main.Master"  AutoEventWireup="true" CodeBehind="frmPSRBeatMaster.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmPSRBeatMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
  <div style="width: 98%;height: 18px;border-radius: 4px;margin: 10px 0px 0px 5px;background-color: #1564ad;padding: 2px 0px 0px 0px;" >
      <span style="font-family: Segoe UI;color:white; font-size: 11px;font-weight: bold;margin: 6px 0px 0px 10px;">PSR - Beat Master</span>
    </div>  
    ...
    <table style="width:100%;text-align:right">
            <tr>
              ...
              <td style="width:80%">
                    <asp:DropDownList ID="DDLSearchFilter" runat="server" CssClass="ddl" data-toggle="dropdown"   Width="200" TabIndex="1"  >                       
                ...
                <td style="width:20%">
                    <div>
                        ...
                        <span id="span1" onmouseover="test()" onmouseout="test1()">
	                        <asp:Button ID="BtnSearch" runat="server" style="margin:0px 0px 0px -2px"  Text="Search" OnClick="BtnSearch_Click" TabIndex="3"></asp:Button>&nbsp;&nbsp;
                        </span>
                   </div>
                   </td>
                </tr>
    ...
    <div  style="margin-left: 0px; height: 300px; width: 99%; overflow:auto">
         ...
         <asp:GridView  ID="gvDetails" runat="server" GridLines="Horizontal" AutoGenerateColumns="False" Width="99%" BackColor="White" 
           BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" ShowHeaderWhenEmpty="True" OnPageIndexChanging="gvDetails_PageIndexChanging1" TabIndex="4">
