<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="frmDiscountViewNew.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmDiscountViewNew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <%--<div class="pane pane--table2 scroll_track">
         <asp:GridView ID="gridViewCustomers" CssClass="fxdheader" runat="server" GridLines="Horizontal" AutoGenerateColumns="false" BackColor="White"
                    BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="0px" CellPadding="3">--%>
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Discount Status" DataField="Discount Status">
                    <HeaderStyle ForeColor="White" HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
