<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmVendingPurchaseReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmVendingPurchaseReport" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlHeader" runat="server" GroupingText="Filter" Style="width: 99%; margin: 0px 0px 0px 10px;">
                <table style="width: 100%">
                    ...
                    <div style="max-height: 60px; overflow-y: auto; width: 100%;">
                        ...
                        <asp:DropDownList ID="chkCustomerName" runat="server" CssClass="dropdown" Width="200px">
                         ...
                         <td class="auto-style5">
                            <asp:RadioButton ID="rdoDetailedView" runat="server" AutoPostBack="true" Text="Detailed View" Checked="true"
                                GroupName="radio" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style5">
                            <asp:RadioButton ID="rdoSummarizedView" runat="server" AutoPostBack="true" Text="Summarised View"
                                GroupName="radio" />
                        </td>
                        <td class="auto-style5">
            ...
            <div style="margin: 10px">
                <asp:UpdatePanel ID="grdpnl" runat="server">
                    <ContentTemplate>
                <asp:Panel ID="Panel2" runat="server" GroupingText="Vending Purchase Report" Width="100%" BackColor="White">
                  <asp:GridView ID="GvVendingPurchase" CssClass = "GridViewClass" runat="server" GridLines="Horizontal" AutoGenerateColumns="true" Width="100%" BackColor="White"
