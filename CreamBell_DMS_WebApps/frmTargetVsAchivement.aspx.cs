...
{
    public partial class frmTargetVsAchivement : System.Web.UI.Page
    {
        ...
        protected void fillCategory()
        {
            ...
            string sqlstr1 = @"select CATEGORY,NAME from AX.ACXTARGETCATEGORY  ORDER BY NAME";
            //drpCategory.Items.Add("All...");
            //baseObj.BindToDropDown(drpCategory, sqlstr1, "NAME", "CATEGORY");
            CreamBell_DMS_WebApps.App_Code.CreamBellFramework.BindToDropDown(drpCategory, sqlstr1, "NAME", "CATEGORY","All...");
        }
        protected void fillSubCategory()
        {
            if (drpCategory.SelectedIndex > 0)
            {
                ...
                string sqlstr1 = @"select SUBCATEGORY,NAME from AX.ACXTARGETSUBCATEGORY where CATEGORY='"+ drpCategory.SelectedItem.Value +"' ORDER BY NAME";
                //drpSubCategory.Items.Add("All...");
                //baseObj.BindToDropDown(drpSubCategory, sqlstr1, "NAME", "SUBCATEGORY");
                CreamBell_DMS_WebApps.App_Code.CreamBellFramework.BindToDropDown(drpSubCategory, sqlstr1, "NAME", "SUBCATEGORY","All...");
            }
        ...
        protected void FillCustomerName()
        {
           ...
           // string sqlstr1 = @"Select distinct(CustGroup_Code),CustGroup_Name from [ax].[ACXCUSTGROUPMASTER] Order BY CustGroup_Code";
            if (ddlSiteId.SelectedIndex >= 0 && drpCustGroup.SelectedIndex>=1)
            {
                string sqlstr1 = @"Select Customer_Code+'-'+Customer_Name as Name,Customer_Code  from ax.ACXCUSTMASTER where CUST_GROUP='" + drpCustGroup.SelectedValue + "' and Site_Code='" + ddlSiteId.SelectedItem.Value + "'";
                //drpCustomerName.Items.Add("All...");
                //baseObj.BindToDropDown(drpCustomerName, sqlstr1, "Name", "Customer_Code");
                CreamBell_DMS_WebApps.App_Code.CreamBellFramework.BindToDropDown(drpCustomerName, sqlstr1, "Name", "Customer_Code","All...");
            }            
        }
        ...
        private void LoadDataInReportViewer(DataTable dtSetData)
        {
            try
            {
                if (dtSetData.Rows.Count > 0)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("Reports\\TargetVsAchivementReport.rdl");
        ...
        protected void ddlCountry_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (objcheckSitecode != null)
            {
                ...
                CreamBell_DMS_WebApps.App_Code.CreamBellFramework.BindToDropDown(ddlSiteId, sqlstr1, "Name", "Code","All...");
