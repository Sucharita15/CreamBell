<%@ Page Title="Product Contribution Report" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmProductContributionReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmProductContributionReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
     ...
     <div style="margin:10px">
                <asp:Panel ID="PanelReport" runat="server" GroupingText="Product Contribution Report" Width="100%"  BackColor="White" >
