<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/New.Master" CodeBehind="frmPurchaseReceiptReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmPurchaseReceiptReport" %>
    ...
    <asp:UpdatePanel ID="uppanel" runat="server" UpdateMode="Conditional">  
     ...
     <asp:UpdatePanel ID="pnlupd" runat="server">
                <ContentTemplate>   
                 ...
                 <asp:Panel ID="PanelReport" runat="server" GroupingText="Purchase Receipt Report" Width="100%"  BackColor="White" >
