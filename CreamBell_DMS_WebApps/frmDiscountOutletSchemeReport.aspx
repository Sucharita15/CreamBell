<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="frmDiscountOutletSchemeReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmDiscountOutletSchemeReport" %>
    ...
    <asp:UpdatePanel runat="server">
        ...
        <ContentTemplate>
            ...
            <div style="margin: 10px">
                <asp:Panel ID="PanelReport" runat="server" GroupingText=" Discount Outlet Scheme Report" Width="100%" BackColor="White">
