<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmFOCSaleInvoiceReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmFOCSaleInvoiceReport" %>
  ...
  <asp:UpdatePanel runat="server">
        ...
        <ContentTemplate>
            ...
            <div style="margin: 10px">
                <asp:Panel ID="PanelReport" runat="server" GroupingText="FOC Sale Invoice Report" Width="100%" BackColor="White">
