<%@ Page Title="" Language="C#" MasterPageFile="~/New.Master" AutoEventWireup="true" CodeBehind="frmVRSVDAttendanceReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.VRSVDAttendanceReport" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlHeader" runat="server" GroupingText="Filter" CssClass="txtLegend" Style="width: 100%; margin: 0px 0px 0px 0px;">
                ...
                <div>
                    ...
                    <asp:ListBox ID="lstSiteId" runat="server" SelectionMode="Multiple" ClientIDMode="Static" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="chkListSite_SelectedIndexChanged"></asp:ListBox>

                    <label>VRS :</label>
                    <%--<asp:DropDownList ID="drpVRS" runat="server" CssClass="textboxStyleNew" Font-Size="Smaller" Height="22px" Width="200px"></asp:DropDownList>--%>
                    <asp:ListBox ID="drpVRSNew" runat="server"  ClientIDMode="Static"></asp:ListBox>  
           ...
           <div style="margin: 10px">
               <asp:Panel ID="PanelReport" runat="server" GroupingText="VRS-VD ATTENDANCE REPORT" Width="100%" BackColor="White">
