<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="frmCustomerWiseSaleReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmCustomerWiseSaleReport" %>
            ...
            <asp:Panel ID="pnlHeader" runat="server" GroupingText="Filter" CssClass="txtLegend" Style="width: 100%; margin: 0px 0px 0px 0px;">
                ...
                <asp:UpdatePanel runat="server" ID="upsale" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        ...
                        <asp:PostBackTrigger ControlID="lstcustomers" />
                ...
                <div>
                    ...
                    <label style="margin-left: 15px; margin-right: 4px">Customers : </label>
                    <asp:ListBox ID="lstcustomers" runat="server" SelectionMode="Multiple" AutoPostBack="true" ClientIDMode="Static" CssClass="txt-width"></asp:ListBox>
                ...
                <div style="margin: 10px">
                    <asp:Panel ID="PanelReport" runat="server" GroupingText="Customer Wise Sale Report" Width="100%" BackColor="White">
