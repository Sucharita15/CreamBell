<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmSchemeExpenseReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmSchemeExpenseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <asp:UpdatePanel runat="server">
        ...
        <ContentTemplate>
            <asp:Panel runat="server" ID="roleFilterPanel" Visible="false">
            ...
            <asp:Panel ID="pnlHeader" runat="server" GroupingText="Filter" Style="width: 100%; margin: 0px 0px 0px 10px;">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td>From Date :</td>
                        <td>
                            <asp:TextBox ID="txtFromDate" runat="server" placeholder="dd-MMM-yyyy" Width="80px" CssClass="textboxStyleNew" Height="11px" OnTextChanged="txtFromDate_TextChanged" AutoPostBack="true"></asp:TextBox>
                            <asp:ImageButton ID="imgBtnFrom" ImageUrl="~/Images/calendar.jpg" ImageAlign="Bottom" runat="server" />
                        </td>
                        <td>
                            <asp:Label Text="State" runat="server" ID="lblState"></asp:Label></td>
                        <td>
                        ...
                        <asp:UpdatePanel ID="Scheme" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <td rowspan="2" style="background-color: aliceblue; vertical-align: top; text-align: left; width: 247px">Scheme:
                    ...
                    <div style="max-height: 60px; overflow-y: auto; width: 100%;">
                        ...
                        <td rowspan="2" style="background-color: aliceblue; vertical-align: top; text-align: left; width: 250px">Business Unit:
                    <div style="max-height: 60px; overflow-y: auto; width: 100%;">

                        <asp:CheckBoxList ID="ChkBunt" runat="server">
                        </asp:CheckBoxList>
                    </div>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>To Date :</td>
                        <td>
                            <asp:TextBox ID="txtToDate" runat="server" placeholder="dd-MMM-yyyy" Width="80px" CssClass="textboxStyleNew" Height="11px" OnTextChanged="txtToDate_TextChanged" AutoPostBack="true"></asp:TextBox>
