<%@ Page Title="Price Master" Language="C#" MasterPageFile="~/New.Master" AutoEventWireup="true" CodeBehind="frmPriceMasterReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmPriceMasterReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	...
	<script type="text/javascript">
        ...
        $(function () {
            ...
            $('#ddlPriceGroupNew').multiselect({
                includeSelectAllOption: true,
                nonSelectedText: 'Select Price Group',
                enableFiltering: true,
                enableCaseInsensitiveFiltering: true,
                buttonWidth: '130px',
                maxHeight: 300,
                    ...
                    <asp:Panel ID="pnlHeader" runat="server"  GroupingText="Filter" CssClass="txtLegend" Style="width: 100%; margin: 0px 0px 0px 0px;">
                        ...
                        <div class="row">
                           ...
                           <asp:ListBox ID="lstSiteId" runat="server" SelectionMode="Multiple" ClientIDMode="Static" OnSelectedIndexChanged="ddlSiteId_SelectedIndexChanged" AutoPostBack="True"></asp:ListBox>                            
                            ...
                            <%--<asp:DropDownList ID="ddlPriceGroup" runat="server" CssClass="textboxStyleNew" Font-Size="Smaller" Height="22px" >
                            </asp:DropDownList>--%>

                              <asp:ListBox ID="ddlPriceGroupNew" ClientIDMode="Static" runat="server"></asp:ListBox>
                          </div>
                
                        <div class="col-md-1" >                    
                            <asp:Button ID="btnGenerate" runat="server" CssClass="ReportSearch" Height="31px" OnClick="btnGenerate_Click" Text="Generate" />
                           
                        
                        </div>  
                            <div class="col-md-1" > 
                                 <asp:Button ID="btnExportToExcel" runat="server" CssClass="ReportSearch" Height="31px" OnClick="btnExportToExcel_Click" Text="Export To Excel" />
                                </div>
                       ...
                       <div style="margin:10px">
                              <asp:Panel ID="PanelReport" runat="server" GroupingText="Price Master" Width="100%"  BackColor="White" >
