<%@ Page Title="" Language="C#" MasterPageFile="~/New.Master" AutoEventWireup="true" CodeBehind="frmCollectionReport1.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmCollectionReport1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	...
	<script type="text/javascript">
        ...
        $(function () {
            ...
            $('#chkCustomerNameNew').multiselect({
                includeSelectAllOption: true,
     ...
     <asp:UpdatePanel ID="pnlupd" runat="server">
                <ContentTemplate>   
                    ...
                    <asp:Panel ID="pnlHeader" runat="server"  GroupingText="Filter" CssClass="txtLegend" Style="width: 100%; margin: 0px 0px 0px 0px;">
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="Panel1" runat="server"  GroupingText="Day Book Report" Style="width: 100%; margin: 0px 0px 0px 0px;">                                        
                       ...
                       <div class="row">
                          ...
                          <label> From Date :</label>
                           ...
                           <asp:ListBox ID="lstSiteId" runat="server" SelectionMode="Multiple" ClientIDMode="Static" OnSelectedIndexChanged="chkListSite_SelectedIndexChanged" AutoPostBack="true" Width="200px"></asp:ListBox>                            
                          ...
                          <div class="col-md-2">
                           <label>Customer Name :</label>                       
                               ...
                               <%-- <asp:CheckBoxList ID="chkCustomerName" runat="server">  </asp:CheckBoxList>--%>

                                   <asp:ListBox ID="chkCustomerNameNew" ClientIDMode="Static" runat="server"
           ...
           <div style="margin:10px">
                 <asp:Panel ID="PanelReport" runat="server" GroupingText="Day Book Report" Width="100%"  BackColor="White" >
