<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmSaleRankingReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmSaleRankingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div style="width: 100%;height: 18px;border-radius: 4px;margin: 5px 0px 0px 10px;background-color: #1564ad;color:white ;padding: 2px 0px 0px 0px; font-weight:bold" >
     ...
     <div style="margin:10px">
                <asp:Panel ID="PanelReport" runat="server" GroupingText="Sale Ranking Report" Width="100%"  BackColor="White" >
