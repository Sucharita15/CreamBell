<%@ Page Title="" Language="C#" MasterPageFile="~/New.Master" AutoEventWireup="true" CodeBehind="frmCustomerOutstandingReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmCustomerOutstandingReport" %>
  ...
  <%--  <script type="text/javascript">
	...
	<script type="text/javascript">
        ...
        $(function () {
            ...
            $('#chkListCustomerGroupNew').multiselect({
                includeSelectAllOption: true,
            ...
            $('#ddlCustomerNameNew').multiselect({
                includeSelectAllOption: true,
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <asp:UpdatePanel ID="uppanel" runat="server" UpdateMode="Conditional">  
        ...
        <ContentTemplate>
           ...
           Customer Outstanding Report</div>
     ...
     <asp:UpdatePanel ID="pnlupd" runat="server">
                <ContentTemplate>   
                    ...
                    <asp:Panel ID="pnlHeader" runat="server"  GroupingText="Filter" CssClass="txtLegend" Style="width: 100%; margin: 0px 0px 0px 0px;">
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="Panel1" runat="server"  GroupingText="Customer Outstanding Report" Style="width: 100%; margin: 0px 0px 0px 0px;">                                        
                        ...
                        <div class="checkboxlistHeader"; style="max-height: 80px; overflow-y: auto; width:160px">
                         ...
                         <div class="checkboxlistHeader"; style="max-height: 80px; overflow-y: auto; width:160px">
                           <span>EXECUTIVE :</span>
                            ...
                            <asp:TextBox ID="txtToDate" runat="server" placeholder="dd-MMM-yyyy" CssClass="textboxStyleNew" Height="11px"></asp:TextBox>
                            <asp:ImageButton ID="imgBtnFrom" style="margin-right:7px" ImageUrl="~/Images/calendar.jpg" ImageAlign="Bottom" runat="server" />
                           ...
                           <asp:ListBox ID="lstSiteId" runat="server" SelectionMode="Multiple" ClientIDMode="Static" OnSelectedIndexChanged="chkListSite_SelectedIndexChanged" AutoPostBack="True"></asp:ListBox>                            
                             
                                     </div>
                                     <div class="col-md-2" > 
                            <label> Customer Group :</label>                       
                            <%--<asp:CheckBoxList ID="chkListCustomerGroup" runat="server" OnSelectedIndexChanged="chkListCustomerGroup_SelectedIndexChanged" CssClass="single-selection" AutoPostBack="true">
                            </asp:CheckBoxList>--%>

                                          <asp:ListBox ID="chkListCustomerGroupNew" ClientIDMode="Static" runat="server" AutoPostBack="true"
                                             OnSelectedIndexChanged="chkListCustomerGroup_SelectedIndexChanged" ></asp:ListBox>
                          ...
                          <%--  <asp:DropDownList ID="ddlCustomerName" runat="server" CssClass="dropdown" Width="200px">
                            </asp:DropDownList>--%>

                                              
                                                                                         
                                          <asp:ListBox ID="ddlCustomerNameNew" ClientIDMode="Static" runat="server"
                         ...
                         <div class="row" style="margin-top:10px">                                
                              <div class="col-md-2">                                     
                                   <asp:RadioButton ID="rdoCORC" runat="server" Text="Customer Wise" GroupName="radio" Checked="true" />
                         <asp:RadioButton ID="rdoCORI" runat="server" Text="Invoice Wise" GroupName="radio" />
                      </div>
                              <div class="col-md-2" > 
                                <asp:Button ID="BtnShowReport0" runat="server" CssClass="ReportSearch" Height="31px" OnClick="BtnShowReport0_Click" Text="Show Report" />
                ...
                <asp:Panel ID="PanelReport" runat="server" GroupingText="Customer Outstanding Report" Width="100%" BackColor="White">
