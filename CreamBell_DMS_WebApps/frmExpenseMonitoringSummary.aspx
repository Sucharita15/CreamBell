<%@ Page Language="C#" Title=" Monitoring  Summary" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmExpenseMonitoringSummary.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmExpenseMonitoringSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
    <asp:UpdatePanel ID="uppanel" runat="server" UpdateMode="Conditional">
      ...
      <ContentTemplate>
         <div style="width: 100%;height: 18px;border-radius: 4px;margin: 5px 0px 0px 10px;background-color: #1564ad;color:white ;padding: 2px 0px 0px 0px; font-weight:bold" >
          Monthly Expense Monitoring Summary Sheet</div>
    ...
    <div style="margin:10px">
         <asp:Panel ID="PanelReport" runat="server" GroupingText="Monthly Expense Monitoring Summary Sheet" Width="100%"  BackColor="White" >
