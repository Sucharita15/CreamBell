<%@ Page Title="Non Buyer Report" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"  CodeBehind="frmNonBuyerReport.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmNonBuyerReport" %>
...
<%--                                        </td>
             ...
             <tr>
                ...
                <td >
                    <asp:DropDownCheckBoxes ID="ddlSiteId" runat="server" AutoPostBack="true"  Width="150" OnSelectedIndexChanged="ddlSiteId_SelectedIndexChanged" CssClass="auto-style13">
                       <Style SelectBoxWidth="250" DropDownBoxBoxHeight="170" > </Style>
                    </asp:DropDownCheckBoxes>
                </td>
                <%--<td >Site ID</td>
                <td >
            ...
            <tr>
               ...
               <td>
                ...
                <td>
                    Customer Group</td>
                <td>
                     <asp:DropDownList ID="drpCustGroup" runat="server" AutoPostBack="True" CssClass="textboxStyleNew" Font-Size="Smaller" Height="22px" OnSelectedIndexChanged="drpCustGroup_SelectedIndexChanged" Width="120px">
                    </asp:DropDownList></td>
           </tr>
            <tr>
                <td>Business Unit</td>
     ...
     <div style="margin:10px">
                <asp:Panel ID="PanelReport" runat="server" GroupingText="NonBuyer" Width="100%"  BackColor="White" >
