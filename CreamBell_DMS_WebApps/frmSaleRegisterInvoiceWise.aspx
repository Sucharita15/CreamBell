<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmSaleRegisterInvoiceWise.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmSaleRegisterInvoiceWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div style="width: 100%;height: 18px;border-radius: 4px;margin: 10px 0px 0px 5px;background-color: #1564ad;color:white ;padding: 2px 0px 0px 0px; font-weight:bold" >
     Sale Regsiter Invoice Wise Detail
     </div>
            ...
            <tr>
                ...
                <td>
                   <%-- <asp:DropDownList ID="DDLBusinessUnit" runat="server" Width="150px"></asp:DropDownList>--%>
                     <asp:ListBox ID="DDLBusinessUnitNew" ClientIDMode="Static" runat="server" 
                           CssClass="single-selection"></asp:ListBox>
                </td>
                <td>
