<%@ Page Title="Secondary Destruction Note" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="frmSecondaryDistructionNote.aspx.cs" Inherits="CreamBell_DMS_WebApps.frmSecondaryDistructionNote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div style="width: 98%; height: 18px; border-radius: 4px; margin: 6px 0px 0px 5px; background-color: #1564ad; padding: 2px 0px 0px 0px;">
        <span style="font-family: Segoe UI; color: white; font-size: 11px; font-weight: bold; margin: 6px 0px 0px 10px;">Secondary Destruction Note </span>
            ...
            <asp:UpdatePanel ID="sdsd" runat="server">
                <ContentTemplate>
                    <table style="width: 98%; border-spacing: 0px">
                        <tr>
                            <td>
                                <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="button" Height="24px" OnClick="btnSave_Click" Width="80px" />
                                <asp:Button ID="btnRefresh" runat="server" CssClass="button" Height="24px" OnClick="btnRefresh_Click" Text="Refresh" />
                            </td>
                            <td>
                                <asp:RadioButton ID="rdoColdRoomDistruction" runat="server" Text="Cold Room Destruction " AutoPostBack="true" OnCheckedChanged="rdoColdRoomDistruction_CheckedChanged" ValidationGroup="aa" GroupName="aa" Checked="true" />

                                <asp:RadioButton ID="rdoMarketReturnDistruction" runat="server" Text="      Market Return Destruction" AutoPostBack="true" OnCheckedChanged="rdMarketReturnDistruction_CheckedChanged" ValidationGroup="aa" GroupName="aa" />
                            </td>
                            <td></td>
                            <td>
                            ...
                            <td></td>
                            <td>
                                <asp:TextBox ID="txtClaimReceivd" Visible="false" ReadOnly="true" runat="server" CssClass="textboxStyleNew" Height="13px" Width="70px" />
                            </td>
                                ...
                                <div id="panelAdd" style="margin-top: 0px; width: 100%;">
                                    <asp:Panel ID="panel1" runat="server" Width="100%">
                                        <table style="width: 100%;" cellpadding="1" cellspacing="0">
                                            <tr>
                                                <td style="width: 8%;">
                                                    <asp:Label ID="lblcustgr" runat="server" Text="Customer Group" /></td>
                                                <td style="width: 15%;">
                                                    <asp:DropDownList ID="ddlCustomerGroup" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCustomerGroup_SelectedIndexChanged" CssClass="dropdownField" Width="90%"></asp:DropDownList>
                                                </td>
                                                <td style="width: 7%;">
                                                    <asp:Label ID="lblCustomer" runat="server" Text="Customer" /></td>
                                                <td style="width: 25%;">
                                                    <asp:DropDownList ID="ddlCustomer" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCustomer_SelectedIndexChanged" CssClass="dropdownField" Width="90%" s></asp:DropDownList>
                                                </td>
                            ...
                            <td style="width: 100%; text-align: left">
                                ...
                                <div id="panelAdd" style="margin-top: 0px; width: 100%;">
                                    <asp:Panel ID="panelAddLine" runat="server" Width="100%">
                                        <table style="width: 100%;" cellpadding="1" cellspacing="0">
                                            <tr>
                                                <td style="width: 15%;"><asp:Label ID="lblBU" runat="server">Business Unit</asp:Label></td>
                                                ...
                                                <td style="width: 5%;">
                                                    <asp:Label ID="lblStockQty" runat="server" Text="Stock Qty" /></td>
                                            ...
                                            <tr>
                                                 <td style="margin-left: 15px">
                                                    <asp:DropDownList ID="ddlBusinessUnit" runat="server" OnSelectedIndexChanged="ddlBusinessUnit_SelectedIndexChanged" CssClass="dropdownField" AutoPostBack="true" Width="100%" />
                                                </td>
                                                <td style="margin-left: 30px">
                                                    <asp:DropDownList ID="DDLMaterialCode" runat="server" OnSelectedIndexChanged="DDLMaterialCode_SelectedIndexChanged" CssClass="dropdownField" AutoPostBack="true" Width="100%" />
                                                </td>
                                                ...
                                                <td style="padding:1px 1px 1px 1px;">
                                                    <asp:Button ID="BtnAddItem" runat="server" Text="Add" OnClick="BtnAddItem_Click" CssClass="button" BackColor="#0066CC" ForeColor="White" />
                                                </td>
                                                <td>
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="ddlCustomerGroup" EventName="SelectedIndexChanged" />
                    ...
                    <asp:AsyncPostBackTrigger ControlID="rdoColdRoomDistruction" EventName="CheckedChanged" />
                    <asp:AsyncPostBackTrigger ControlID="rdoMarketReturnDistruction" EventName="CheckedChanged" />

                    <%--  <asp:PostBackTrigger ControlID="DDLMaterialCode" />
                    <asp:PostBackTrigger ControlID="txtBoxQty" />
                    <asp:PostBackTrigger ControlID="txtPcsQty" />
                    <asp:PostBackTrigger ControlID="btnSave" />
                    <asp:PostBackTrigger ControlID="btnRefresh" />
                    <asp:PostBackTrigger ControlID="rdoColdRoomDistruction" />
                    <asp:PostBackTrigger ControlID="rdoMarketReturnDistruction" />--%>
                </Triggers>
            </asp:UpdatePanel>
